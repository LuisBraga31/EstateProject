  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'>
      <div className='container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent'>
        ...
        <button className="hidden md:block bg-white px-8 py-1 rounded-full"> Sign Up</button>
      ...
      overflow-hidden bg-white transition-all`}>
        <div className='flex justify-end p-6'>
          <img src={assets.cross_icon} className='w-6 cursor-pointer' alt="" onClick={() => setShowMobileMenu(false)}/>
        </div>
